> This is the original README from TwentyTwentyObjects by maxbickett, preserved unmodified for reference and attribution. For this fork (Highlight Interactables), see [README.md](README.md).
...
```
TwentyTwentyObjects/
â”œâ”€â”€ TwentyTwentyObjects.omwscripts
â””â”€â”€ scripts/
    â””â”€â”€ TwentyTwentyObjects/
        â”œâ”€â”€ init.lua
        â”œâ”€â”€ player_native.lua
        â”œâ”€â”€ settings_improved.lua
        â”œâ”€â”€ hotkeyListener.lua
        â””â”€â”€ util/
            â”œâ”€â”€ labelLayout_jitter.lua
            â”œâ”€â”€ labelRenderer_native.lua
            â”œâ”€â”€ logger.lua
            â”œâ”€â”€ occlusion.lua
            â”œâ”€â”€ projection.lua
            â”œâ”€â”€ spatial.lua
            â””â”€â”€ storage.lua
```
...
1. Open Settings â†’ Mods â†’ Twenty Twenty Objects
2. Click the "Quick Start" tab
3. Choose a preset that matches your playstyle:
   - **ðŸ—¡ï¸ Loot Hunter**: Find valuable items and containers (Default: `M`)
   - **ðŸ‘¥ NPC Tracker**: Locate NPCs in towns or dungeons (Default: `N`)
   - **ðŸ’Ž Thief's Eye**: Spot valuable items, containers, and doors (Default: `B`)
   - **ðŸ›ï¸ Dungeon Delver**: See all interactable objects (items, containers, doors, activators, NPCs, creatures) within 1500 units (Default: `V`)
...
2. Go to Settings â†’ Mods â†’ Twenty Twenty Objects
